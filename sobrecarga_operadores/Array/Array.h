...
public:
  ...
  Array operator+(const Array &) const; //permite a concatenação de um objeto Array com outro. Não modifica o objeto invocador.

  Array &operator+=(const Array &); //permite a concatenação de um objeto Array com outro. Modifica o objeto invocador.
